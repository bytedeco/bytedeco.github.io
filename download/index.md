...
All binary and source artifacts for [JavaCPP](https://github.com/bytedeco/javacpp), [JavaCPP Presets](https://github.com/bytedeco/javacpp-presets), [JavaCV](https://github.com/bytedeco/javacv), [sbt-javacpp](https://github.com/bytedeco/sbt-javacpp), [sbt-javacv](https://github.com/bytedeco/sbt-javacv), [ProCamCalib](https://github.com/bytedeco/procamcalib), and [ProCamTracker](https://github.com/bytedeco/procamtracker) are made available as release archives on the GitHub repositories as well as through the <a href="http://search.maven.org/#search|ga|1|bytedeco">Maven Central Repository</a>, so you can make your build files depend on them (as shown in the [Maven Dependencies](#maven-dependencies) section below), and they will get downloaded automatically, but one can also download everything manually. These archives contain all that is available from the latest releases. In the case of JavaCPP Presets, please remember to either depend on artifacts that contain `-platform` in their names, or include also the platform-specific artifacts as well.
